...
public class AriaUtil {
	...
	private final String STR_MASTER_KEY = "!@#iHopper~~";
	...
	public AriaUtil() {
		createMasterKey(STR_MASTER_KEY);
	}
	...
	private Boolean createMasterKey(String masterKey) {

		int nSize = masterKey.length();
		...
		try {
			strByte = masterKey.getBytes("UTF-8");
