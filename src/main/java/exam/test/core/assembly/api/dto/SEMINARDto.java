...
public class SEMINARDto {
	...
	@JsonProperty ("PLANNER")    private String planner;  // 기획자
	@JsonProperty ("PANAL")      private String pannel;   // 패널
	@JsonProperty ("REG_DTTM")   private String wrt_dt;   // 작성일
	@JsonProperty ("OPEN_DTTM")  private String host_dt;  // 개최일
	@JsonProperty ("DETAIL_URL") private String detl_url; // 상세 URL
