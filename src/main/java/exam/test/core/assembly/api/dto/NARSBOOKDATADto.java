...
@Setter
@ToString
public class NARSBOOKDATADto {

	@JsonProperty ("DATA_SEQCE_NO") private String data_collect_no; // 데이터수집번호
	@JsonProperty ("DATAID")        private String data_id;         // 데이터ID
	@JsonProperty ("PDFFILENM")     private String pdffilenm;       // 다운로드(미변환)
	@JsonProperty ("PDFFILEURL")    private String detl_url;        // PDF파일URL
	@JsonProperty ("DIRECTVIEW")    private String directview;      // 바로보기(미변환)
	@JsonProperty ("VIEWERURL")     private String viewer_url;      // 뷰어URL
	@JsonProperty ("DIVNM")         private String div_nm;          // 구분명
	@JsonProperty ("DIVCD")         private String div_cd;          // 구분코드
