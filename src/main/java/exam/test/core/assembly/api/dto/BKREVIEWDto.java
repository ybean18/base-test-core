...
@Setter
@ToString
public class BKREVIEWDto {

	@JsonProperty ("TITLE")      private String ttle;       // 제목
	@JsonProperty ("WRITER")     private String author;     // 저자
	@JsonProperty ("PUBLISHER")  private String publisher;  // 출판사
	@JsonProperty ("REG_DTTM")   private String pbct_dt;    // 발간일
	@JsonProperty ("DETAIL_URL") private String viewer_url; // 뷰어url
