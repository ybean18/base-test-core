...
/******************************************************************************/
/******************************************************************************/
@Service("nexgtxtmaamffofof")
public class AssemblyApiServiceNexgtxtmaamffofof implements AssemblyApiService {

	@Autowired
	private WebClient assemblyApiClient;

	private final String API_NAME = "nexgtxtmaamffofof";
